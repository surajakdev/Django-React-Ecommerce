...
from django.db.models.fields import BLANK_CHOICE_DASH # added
...
class OrderItem(models.Model):
    product = models.ForeignKey(Product, on_delete=models.CASCADE,null=True) # that is if a specific product product is deleted, then its associated  order should be deleted.
